    ...
    170: function(e, n, t) {
      ...
      var r = t(2),
        ...
        p = {
          ...
          title: "Command line tools",
          description: "Setup",
          source: "@site/docs/usage-cli.md",
          permalink: "/docs/usage-cli",
          editUrl:
            "https://github.com/crcn/paperclip/packages/edit/master/website/docs/usage-cli.md",
          sidebar_label: "CLI",
          sidebar: "docs",
          previous: {
        ...
        o = [
          { value: "Setup", id: "setup", children: [] },
          { value: "Examples", id: "examples", children: [] }
        ],
        l = { rightToc: o };
      function u(e) {
        var n = e.components,
          t = Object(i.a)(e, ["components"]);
        return Object(a.b)(
          "wrapper",
          Object(r.a)({}, l, t, { components: n, mdxType: "MDXLayout" }),
          Object(a.b)("h2", { id: "setup" }, "Setup"),
          Object(a.b)(
            "p",
            null,
            "To initialize a new project, run ",
            Object(a.b)("inlineCode", { parentName: "p" }, "paperclip init"),
            ". This will ask you a few questions, then write a ",
            Object(a.b)(
              "inlineCode",
              { parentName: "p" },
          ...
          Object(a.b)(
            ...
            null,
            "Next, add a ",
            Object(a.b)("inlineCode", { parentName: "p" }, ".pc"),
          ...
          Object(a.b)("h2", { id: "examples" }, "Examples"),
          Object(a.b)(
            "pre",
            null,
            Object(a.b)(
      ...
      var l = i.a.createContext({}),
        ...
        d = i.a.forwardRef(function(e, n) {
          var t = e.components,
            ...
            s = u(t),
            d = r,
            m = s["".concat(c, ".").concat(d)] || s[d] || b[d] || a;
          return t
            ? i.a.createElement(m, p(p({ ref: n }, l), {}, { components: t }))
            : i.a.createElement(m, p({ ref: n }, l));
        });
      function m(e, n) {
        var t = arguments,
          r = n && n.mdxType;
        if ("string" == typeof e || r) {
          ...
          c[0] = d;
          var p = {};
          for (var o in n) hasOwnProperty.call(n, o) && (p[o] = n[o]);
          (p.originalType = e),
            (p.mdxType = "string" == typeof e ? e : r),
            (c[1] = p);
          for (var l = 2; l < a; l++) c[l] = t[l];
          return i.a.createElement.apply(null, c);
        }
        return i.a.createElement.apply(null, t);
      }
