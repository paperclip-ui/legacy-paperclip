/*! For license information please see 2.07d0b69c.js.LICENSE.txt */
    ...
    256: function(e, t, a) {
      ...
      var n = a(0),
        ...
        u = function() {
          ...
          return (
            ...
            { isDarkTheme: r === s, setLightTheme: u, setDarkTheme: d }
          );
        },
        d = a(294);
      var f = function(e) {
          ...
          return r.a.createElement(
            d.a.Provider,
            { value: { isDarkTheme: a, setLightTheme: n, setDarkTheme: c } },
            e.children
          );
        },
        m =
                ...
                try {
                  for (var e = {}, t = 0; t < localStorage.length; t += 1) {
                    ...
                    if (n.startsWith("docusaurus.tab."))
                      e[
                        n.substring("docusaurus.tab.".length)
            ...
            Object(n.useEffect)(function() {
              if (a) {
                var e = localStorage.getItem("docusaurus.announcement.id"),
                  t = a !== e;
                localStorage.setItem("docusaurus.announcement.id", a),
                  t &&
      ...
      var b = function(e) {
          var t = m(),
            ...
            c = h(),
            o = c.isAnnouncementBarClosed,
            l = c.closeAnnouncementBar;
          return r.a.createElement(
            v.a.Provider,
            {
              value: {
                ...
                isAnnouncementBarClosed: o,
                closeAnnouncementBar: l
              }
            },
            e.children
          );
      ...
      var E = function() {
          var e = Object(o.a)().siteConfig,
            ...
            l = a.textColor,
            i = Object(p.a)(),
            s = i.isAnnouncementBarClosed,
            u = i.closeAnnouncementBar;
          return !n || s
            ? null
            : r.a.createElement(
                "div",
                {
                  ...
                  style: { backgroundColor: c, color: l },
                  role: "banner"
                },
        ...
        B = function() {
          return r.a.createElement("span", {
            className: Object(j.a)(S.a.toggle, S.a.moon)
          });
        },
        x = function() {
          return r.a.createElement("span", {
            className: Object(j.a)(S.a.toggle, S.a.sun)
          });
        },
        L = function(e) {
            ...
            Object(O.a)(
              {
                ...
                icons: {
                  ...
                  unchecked: r.a.createElement(x, null)
                }
              },
              e
            )
          ...
          return (
            Object(A.a)(
              function(t) {
                var a = t.scrollY;
                if (e && (0 === a && r(!0), !(a < f))) {
                  if (o) return l(!1), r(!1), void u(a);
                  var n = document.documentElement.scrollHeight - f,
      ...
      function G(e) {
        var t = e.activeBasePath,
          ...
          o = e.label,
          i = e.activeClassName,
          s = void 0 === i ? "navbar__link--active" : i,
          ...
          f = Object(l.a)(n),
          m = Object(l.a)(t),
          h = Object(l.a)(c, { forcePrependBaseUrl: !0 });
        return r.a.createElement(
          y.a,
          Object(O.a)(
            {},
            c
              ...
              : Object.assign(
                  { isNavLink: !0, activeClassName: s, to: f },
                  t || a
                    ? {
                        isActive: function(e, t) {
                          return a
                            ? new RegExp(a).test(t.pathname)
                            : t.pathname.startsWith(m);
                        }
                      }
                    : null
                ),
      ...
      function Y(e) {
        var t = e.items,
          ...
          n = void 0 === a ? "right" : a,
          c = e.className,
          o = Object(_.a)(e, ["items", "position", "className"]),
          l = function(e, t) {
            return (
              void 0 === t && (t = !1),
              Object(j.a)(
        ...
        return t
          ...
          : r.a.createElement(G, Object(O.a)({ className: l(c) }, o));
      }
      function W(e) {
        var t = e.items,
          a = (e.position, e.className),
          n = Object(_.a)(e, ["items", "position", "className"]),
          c = function(e, t) {
            return (
              void 0 === t && (t = !1),
              Object(j.a)("menu__link", { "menu__link--sublist": t }, e)
            );
          };
        return t
          ? r.a.createElement(
      ...
      var V = function() {
          ...
          var Q = (function(e) {
              return {
                ...
                rightLinks: e.filter(function(e) {
                  var t;
                  return (
                    "right" ===
                    (null !== (t = e.position) && void 0 !== t ? t : "right")
          ...
          return r.a.createElement(
            "nav",
            {
              ...
              className: Object(j.a)(
                ...
                "navbar--light",
                "navbar--fixed-top",
                ((e = { "navbar-sidebar--show": p }),
                (e[U.a.navbarHideable] = f),
                (e[U.a.navbarHidden] = !D),
                e)
              )
            },
            r.a.createElement(
              ...
              r.a.createElement(
                ...
                r.a.createElement(
                  y.a,
                  Object(O.a)({ className: "navbar__brand", to: A }, H),
                  null != G &&
                ...
                Z.map(function(e, t) {
                  return r.a.createElement(Y, Object(O.a)({}, e, { key: t }));
                })
              ),
              r.a.createElement(
                "div",
                ...
                r.a.createElement(C, {
                  handleSearchBarToggle: _,
                  isSearchBarExpanded: E
                })
              )
            ),
            r.a.createElement("div", {
            ...
            r.a.createElement(
              ...
              r.a.createElement(
                ...
                r.a.createElement(
                  y.a,
                  Object(O.a)(
                    { className: "navbar__brand", onClick: J, to: A },
                    H
                  ),
                  null != G &&
                    r.a.createElement("img", {
      ...
      function K(e) {
        var t = e.to,
          ...
          o = Object(_.a)(e, ["to", "href", "label", "prependBaseUrlToHref"]),
          i = Object(l.a)(t),
          s = Object(l.a)(a, { forcePrependBaseUrl: !0 });
        return r.a.createElement(
          y.a,
          Object(O.a)(
                        ...
                        d.href
                          ? r.a.createElement(
                              "a",
                              {
                                ...
                                target: "_blank",
                                rel: "noopener noreferrer",
                                className: J.a.footerLogoLink
                              },
                              r.a.createElement(q, { alt: d.alt, url: f })
                            )
                          : r.a.createElement(q, { alt: d.alt, url: f })
                      ),
                    r.a.createElement("div", {
        ...
        return r.a.createElement(
          ...
          r.a.createElement(
            ...
            r.a.createElement(
              ...
              _ && r.a.createElement("title", null, _),
              _ &&
                r.a.createElement("meta", { property: "og:title", content: _ }),
              n && r.a.createElement("link", { rel: "shortcut icon", href: C }),
              v &&
                r.a.createElement("meta", { name: "description", content: v }),
              v &&
              ...
              j &&
                r.a.createElement("meta", { property: "og:image", content: y }),
              j &&
                r.a.createElement("meta", {
              ...
              k && r.a.createElement("link", { rel: "canonical", href: u + k }),
              r.a.createElement("meta", {
                name: "twitter:card",
            ...
            r.a.createElement("div", { className: "main-wrapper" }, d),
            !h && r.a.createElement(Q, null)
          )
        );
      };
    },
      ...
      if (
        ...
        s = function(e, t) {
          var a = this instanceof s,
            n = l(e),
            c = void 0 === t;
          return !a && n && e.constructor === s && c
            ? e
            : r(
                h
                  ? new u(n && !c ? e.source : e, t)
                  : u(
        ...
        for (
          ...
          v(b[p++]);
        (d.constructor = s), (s.prototype = d), a(15)(n, "RegExp", s);
      }
      a(88)("RegExp");
    },
    300: function(e, t, a) {
        ...
        return (
          Object(n.useEffect)(function() {
            return (
              ...
              function() {
                return window.removeEventListener("scroll", l, { passive: !0 });
              }
            );
          }, t),
          r
    ...
    304: function(e, t, a) {
      ...
      t.a = function() {
        var e = Object(n.a)().siteConfig,
          t = (e = void 0 === e ? {} : e).themeConfig.navbar,
          a = (t = void 0 === t ? {} : t).logo,
          l = void 0 === a ? {} : a,
          i = Object(r.a)().isDarkTheme,
          s = Object(c.a)(l.href || "/"),
          u = {};
        l.target
          ? (u = { target: l.target })
        ...
        var d = l.srcDark && i ? l.srcDark : l.src;
        return {
          logoLink: s,
          logoLinkProps: u,
          logoImageUrl: Object(c.a)(d),
          logoAlt: l.alt
        };
      };
    },
          ...
          ("__proto__" in {}
            ? (function(e, t, n) {
                try {
                  (n = a(29)(
                    Function.call,
                    a(284).f(Object.prototype, "__proto__").set,
                    2
                  ))(e, []),
                ...
                return function(e, a) {
                  return c(e, a), t ? (e.__proto__ = a) : n(e, a), e;
                };
              })({}, !1)
            : void 0),
        check: c
