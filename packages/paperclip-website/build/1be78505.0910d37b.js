  ...
  [7, 40],
  {
    140: function(e, t, n) {
      ...
      const y = (e, t) =>
        "link" === e.type
          ? ((e, t) => {
              const n = e => (e.endsWith("/") ? e : e + "/");
              return n(e) === n(t);
            })(e.href, t)
          : "category" === e.type && e.items.some(e => y(e, t));
      function x({
        item: e,
        onItemClick: t,
        collapsible: n,
        ...
        const { items: s, label: c } = e,
          ...
          [f, h] = Object(r.useState)(() => !!n && !d && e.collapsed);
        Object(r.useEffect)(() => {
          d && !p && f && h(!1);
        }, [d, p, f]);
        const m = Object(r.useCallback)(
          e => {
            e.preventDefault(), h(e => !e);
          },
          [h]
        );
        return 0 === s.length
          ...
          : i.a.createElement(
              "li",
              {
                className: Object(u.a)("menu__list-item", {
              ...
              i.a.createElement(
                ...
                Object(l.a)(
                  {
                    className: Object(u.a)("menu__link", {
                      "menu__link--sublist": n,
                      "menu__link--active": n && d,
                      [b.a.menuLinkText]: !n
                    }),
                    onClick: n ? m : void 0,
                    href: n ? "#!" : void 0
      ...
      function E({
        ...
        const { href: o, label: s } = e,
          c = y(e, n);
        return i.a.createElement(
          "li",
          { className: "menu__list-item", key: s },
          i.a.createElement(
            v.a,
            Object(l.a)(
              {
      ...
      var N = function(e) {
          const [t, n] = Object(r.useState)(!1),
            {
              siteConfig: {
                themeConfig: { navbar: { title: a, hideOnScroll: s = !1 } = {} }
              } = {},
              isClient: c
            } = Object(o.a)(),
            {
            ...
            { isAnnouncementBarClosed: E } = Object(d.a)(),
            { scrollY: N } = Object(m.a)(),
            { docsSidebars: w, path: C, sidebar: A, sidebarCollapsible: k } = e;
          Object(p.a)(t);
          const O = Object(f.a)();
          if (
            (Object(r.useEffect)(() => {
          ...
          if (!R)
            throw new Error(
              `Cannot find the sidebar "${A}" in the sidebar config!`
            );
          return i.a.createElement(
            "div",
            {
              className: Object(u.a)(b.a.sidebar, {
                [b.a.sidebarWithHideableNavbar]: s
              })
            },
            s &&
              i.a.createElement(
                v.a,
                Object(l.a)(
                  { tabIndex: "-1", className: b.a.sidebarLogo, to: g },
                  _
                ),
                null != y &&
                  i.a.createElement("img", { key: c, src: y, alt: x }),
                null != a && i.a.createElement("strong", null, a)
              ),
            i.a.createElement(
              "div",
              {
                className: Object(u.a)("menu", "menu--responsive", b.a.menu, {
                  "menu--show": t,
                  [b.a.menuWithAnnouncementBar]: !E && 0 === N
                })
              },
              i.a.createElement(
                "button",
      ...
      t.default = function(e) {
        const { route: t, docsMetadata: n, location: r } = e,
          l = t.routes.find(e => Object(A.a)(r.pathname, e)) || {},
          { permalinkToSidebar: u, docsSidebars: d, version: p } = n,
          f = u[l.path],
          { siteConfig: { themeConfig: h = {} } = {}, isClient: m } = Object(
            o.a
          )(),
          { sidebarCollapsible: v = !0 } = h;
        return 0 === Object.keys(l).length
          ? i.a.createElement(C.default, e)
          : i.a.createElement(
              c.a,
              { version: p, key: m },
              i.a.createElement(
                "div",
                { className: O.a.docPage },
                f &&
                  i.a.createElement(
                    "div",
                    {
                      className: O.a.docSidebarContainer,
                      role: "complementary"
                    },
                    i.a.createElement(N, {
                      docsSidebars: d,
                ...
                i.a.createElement(
                  "main",
                  { className: O.a.docMainContainer },
                  i.a.createElement(
                    a.a,
                    { components: w.a },
                    Object(s.a)(t.routes)
                ...
                if (e.kind === l.EngineEventKind.Evaluated) {
                  ...
                  for (
                    ...
                    !i.allDependencies.includes(h) &&
                      r._rendered[h] &&
                      p.push({ uri: h, sheet: r._rendered[h].sheet });
                  }
                  (p.length || s.length) &&
                    r._dispatch({
                      uri: e.uri,
    ...
    192: function(e, t, n) {
      ...
      exports.patchNativeNode = function(e, t, n, r) {
        for (var l = 0, u = t; l < u.length; l++) {
          ...
          switch (f.kind) {
            case a.ActionKind.DeleteChild:
              var h = p.childNodes[f.index];
              p.removeChild(h);
              break;
            case a.ActionKind.InsertChild:
              var m = i.createNativeNode(f.child, n, r, p.namespaceURI);
              f.index >= p.childNodes.length
                ? p.appendChild(m)
                : p.insertBefore(m, p.childNodes[f.index]);
              break;
            case a.ActionKind.ReplaceNode:
              var v = p.parentNode;
              v.insertBefore(
                i.createNativeNode(f.replacement, n, r, v.namespaceURI),
                p
              ),
                p.remove();
              break;
    ...
    193: function(e, t, n) {
      ...
      function v() {
        return (
          (null !== m && m.buffer === l.memory.buffer) ||
            (m = new Uint8Array(l.memory.buffer)),
          m
        );
      }
      function g(e, t) {
        return h.decode(v().subarray(e, e + t));
      }
      function _(e) {
      ...
      const A = (async function e(t) {
        ...
        k = Object(c.createEngine)(async (...e) => (await A, C.new(...e)));
      var O = n(206),
        R = n.n(O),
        P = n(207),
        j = n(189),
      ...
      const M = ({ React: e, useState: t, useEffect: n, useRef: r }) => {
        const c = T()(e => e, { serializer: e => JSON.stringify(e) }),
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(R.a, {
                ...
                highlight: e => Object(P.highlight)(e, P.languages.html)
              })
            ),
            e.createElement(l, { engine: v, currentUri: f })
          );
        };
      };
    },
