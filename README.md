...
Paperclip allows you to define UI primitives out of plain HTML & CSS. The goal of the library is centered around increasing the speed, safety, and accuracy of developing web interfaces. Here's how:
