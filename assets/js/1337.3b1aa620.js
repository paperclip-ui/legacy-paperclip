...
/* harmony export */ });
/* harmony import */ var _paperclip_bg_wasm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29059);
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.PCSourceWriter=void 0;var mutations_1=__webpack_require__(20827);var utils_1=__webpack_require__(85402);var string_editor_1=__webpack_require__(41376);var ANNOTATION_KEYS=["title","width","height","x","y"];// TODO: add more tests here
...
value:buffer.join("")};};return PCSourceWriter;}();exports.PCSourceWriter=PCSourceWriter;var getAssocNode=function(exprTextSource,root){var foundExpr;(0,utils_1.traverseExpression)(root,function(node){if(node.range.start.pos===exprTextSource.range.start.pos&&node.range.end.pos===exprTextSource.range.end.pos){foundExpr=node;return false;}});// should NOT happen
...
var __webpack_instantiate__ = ([WEBPACK_IMPORTED_MODULE_0]) => {
	return __webpack_require__.v(exports, module.id, "1fe23873e3b19edc", {
		"./paperclip_bg.js": {
...
__webpack_require__.a(module, (__webpack_handle_async_dependencies__) => {
	/* harmony import */ var WEBPACK_IMPORTED_MODULE_0 = __webpack_require__(82483);
...
;// CONCATENATED MODULE: ../paperclip-core/esm/core/infer.js
...
;// CONCATENATED MODULE: ../paperclip-core/esm/core/utils.js
...
const noop=()=>{};
;// CONCATENATED MODULE: ../paperclip-core/esm/core/delegate.js
// 🙈
...
;// CONCATENATED MODULE: ../paperclip-core/esm/core/index.js

;// CONCATENATED MODULE: ../paperclip-core/browser.js
const loadEngineDelegate=async(options,onCrash)=>{// need this here since webpack tree shakes it out
await Promise.resolve().then(()=>_interopRequireWildcard(__webpack_require__(29059)));const{NativeEngine}=await Promise.resolve().then(()=>_interopRequireWildcard(__webpack_require__(82483)));const{readFile,fileExists,resolveFile,getLintConfig}=options.io;return new EngineDelegate(NativeEngine.new(readFile,fileExists,resolveFile,getLintConfig,options.mode||EngineMode.MultiFrame),options.io,onCrash||function(e){console.error(e);});};
